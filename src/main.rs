...
const UUID_TESTNET: u64 = 5_283_967_947_175_248_524;
const UUID_MAINNET: u64 = 11_024_959_585_341_937_636;
...
fn main() {
    ...
    let network = start_network_thread(conf, stop_flag.clone(), blocks.clone());
